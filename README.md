...
## 🗂️ Slope classes / Classes de pente

| Class | Label EN | Label FR | Range |
|---|---|---|---|
| `lt5`   | Flat     | Plat     | < 5 %       |
| `5_15`  | Moderate | Modéré   | 5 % – 15 %  |
| `15_25` | Steep    | Pentu    | 15 % – 25 % |
| `25_35` | Hard     | Raide    | 25 % – 35 % |
| `gt35`  | Extreme  | Extrême  | > 35 %      |
...
- [x] **P3** — GPX algorithm / Algo GPX (parsing, segmentation, stats) — *strict TDD*
- [x] **P4** — REST API (7 endpoints + feature tests)
- [x] **P5** — Vue.js frontend / Frontend (dashboard, charts, dynamic filters)
- [x] **P6** — Quality / Qualité (99% coverage, PHPDoc, Pint, ESLint)
